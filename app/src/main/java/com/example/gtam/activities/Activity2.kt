            ...
            GTAMTheme {
                Surface(
                    ...
                    Column (modifier = Modifier.verticalScroll(rememberScrollState())) {
                        ...
                        // Identity
                        banner.LittleText("Name", modifier = Modifier, button, Strings.A2M1)
                        input.InputField(clientName, { clientName = it }, "Client's Name")
                        banner.LittleText("Address", modifier = Modifier, button, Strings.A2M2)
                        input.InputField(clientAddress, { clientAddress = it }, "Client's Address")
                        // Email
                        banner.LittleText("Email", modifier = Modifier, button, Strings.A2M3)
                        input.InputField(clientEmail,{ clientEmail = it },"Client's Email")
                        // Phone Number
                        banner.LittleText("Phone", modifier = Modifier, button, Strings.A2M4)
