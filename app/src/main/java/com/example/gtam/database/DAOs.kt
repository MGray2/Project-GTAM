...
interface UserBotDao {
    ...
    @Query("UPDATE user_bot SET email = :email, username = :username, password = :password, phoneNumber = :phoneNumber, messageHeader = :messageHeader, messageFooter = :messageFooter WHERE id = 1")
    suspend fun updateUserBot(email: String, username: String, password: String, phoneNumber: String, messageHeader: String, messageFooter: String)
